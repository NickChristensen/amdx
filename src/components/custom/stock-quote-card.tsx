...
export const stockQuoteCardMdxDocs = {
  ...
  examples: [
    {
      title: "Basic stock quotes",
      mdx: `<StockQuoteCard symbols={["AAPL", "MSFT", "NVDA"]} />`,
    },
    {
      title: "Unavailable quote state",
      mdx: `<StockQuoteCard symbols={[]} />`,
    },
  ],
} as const satisfies AgentMdxComponentDocs<StockQuoteCardProps>;
