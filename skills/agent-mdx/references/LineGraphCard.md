...
Displays a changing series as a filled line chart in a card.
...
```ts
export const lineGraphCardDefaults = {} satisfies AgentMdxDefaults<ChartProps>;
```
